...
| Script | Purpose |
|--------|---------|
| `scripts/generate_courses.py` | Generate 5000+ dummy courses into MongoDB (`is_embedded=false`). |
...
- **12-category taxonomy** in `backend/app/constants/categories.py` and
  `frontend/src/constants/categories.js` is the single source of truth.
